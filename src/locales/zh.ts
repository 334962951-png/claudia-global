...
export const zh: Translations = {
  ...
  pricing: {
    title: "定价",
    description: "配置模型定价用于费用追踪。支持 Anthropic、OpenRouter 和自定义 Provider。",
    builtIn: "内置",
    custom: "自定义",
    models: "个模型",
    modelId: "模型 ID",
    ...
    noCustomProviders: "尚未配置自定义定价 Provider。",
    addProviderHint: "点击「添加 Provider」来定义您自己的模型定价。",
    saved: "定价配置已保存",
    saveFailed: "保存定价配置失败",
    imported: "已从剪贴板导入 Provider",
    importFailed: "导入失败 — 请先将有效的 JSON 复制到剪贴板",
    copiedToClipboard: "自定义 Provider 已复制到剪贴板",
    import: "导入",
    export: "导出",
  },
};
