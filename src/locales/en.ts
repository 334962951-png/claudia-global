...
export const en: Translations = {
  ...
  pricing: {
    title: "Pricing",
    description: "Configure model pricing for cost tracking. Supports Anthropic, OpenRouter, and custom providers.",
    builtIn: "Built-in",
    custom: "Custom",
    models: "models",
    modelId: "Model ID",
    ...
    noCustomProviders: "No custom pricing providers configured.",
    addProviderHint: "Click 'Add Provider' to define your own model pricing.",
    saved: "Pricing saved successfully",
    saveFailed: "Failed to save pricing",
    imported: "Providers imported from clipboard",
    importFailed: "Failed to import — copy valid JSON to clipboard first",
    copiedToClipboard: "Custom providers copied to clipboard",
    import: "Import",
    export: "Export",
  },
};
